...
public class ApprovalMoneyRequestAdapter extends ArrayAdapter<String> {
    ...
    private ArrayList<String> balanceStatusList ;

    private List<RegisterUsersInGameEntity> registerUsersInGameEntityArray;
    public ApprovalMoneyRequestAdapter(Activity context,
                               ...
                               , ArrayList<String> balanceStatusList) {
        super(context, R.layout.custom_approval_money_request_ui, userIdList);
        ...
        this.balanceStatusList = balanceStatusList;

    }

    public View getView(int position, View view, ViewGroup parent) {
        LayoutInflater inflater = context.getLayoutInflater();
        View rowView = inflater.inflate(R.layout.custom_approval_money_request_ui, null, true);
        ...
        TextView balanceStatus = (TextView) rowView.findViewById(R.id.status);
        ...
        balanceStatus.setText("Submitted From: " +balanceStatusList.get(position));
